...
const BASE_SKILLS: Omit<DashboardSkill, "id">[] = [
  { name: "/competitor-research", category: "Research", description: "Track pricing, offers, and positioning across brands.", enabled: true },
  { name: "/scrape-ads", category: "Research", description: "Ingest competitor creatives from Meta Ads Library.", enabled: true },
  ...
  { name: "/summarize", category: "Research", description: "Condense long intel into actionable briefs.", enabled: true },
  { name: "Amazon listing audit", category: "Research", description: "Score listings vs. category leaders.", enabled: false },
  { name: "/script-ads", category: "Content", description: "Turn intel into campaign angles and UGC scripts.", enabled: true },
  { name: "/generate-ad-statics", category: "Content", description: "Generate static variants from winning angles.", enabled: true },
  { name: "/static-to-video", category: "Content", description: "Animate static frames into video creatives.", enabled: true },
  ...
  { name: "/listing-optimizer", category: "Store", description: "Titles, bullets, and backend keywords.", enabled: true },
  { name: "/store-health-monitor", category: "Store", description: "Catalog health checks and recommendations.", enabled: true },
  ...
  { name: "/launch-ads", category: "Ads", description: "Scale, pause, and refresh on CPA rules.", enabled: true },
