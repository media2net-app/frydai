...
function TestimonialCard({
  ...
  return (
    <GlassCard className="flex h-full flex-col p-5 transition-colors hover:border-violet-500/25 sm:p-6">
      <span className="text-2xl leading-none text-violet-400/50" aria-hidden>
        &ldquo;
      </span>
      <p className="mt-3 flex-1 text-sm leading-relaxed text-white/75 sm:text-base">{quote}</p>
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <p className="mt-6 text-center text-[10px] text-white/35">{t.footnote}</p>
